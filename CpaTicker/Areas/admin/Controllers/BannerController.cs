...
namespace CpaTicker.Areas.admin.Controllers
{
    ...
    public class BannerController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            //var activeCampaigns= repo.Campaigns().Where(u => u.Status == Status.Active && u.CustomerId==user.CustomerId).Select(u => u.CampaignId);
            var hidden = user.HiddenCampaigns.Select(h => h.Campaign.CampaignId);
            //return View(repo.Banners().Where(b => b.CustomerId == user.CustomerId && !hidden.Contains(b.CampaignId) && activeCampaigns.Contains(b.CampaignId)));
