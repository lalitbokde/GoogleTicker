...
/*
 * CUSTOM CONFIGURATION (njhones config)
 * Description: Enable / disable certain theme features here
 */
	//$.doajaxrequest = true;
...
$(document).ready(function() {
	...
	*/
	...
	//$.root_.removeClassPrefix('smart-style').addClass("smart-style-2");
	//$logo.attr('src', $this.data("img/logo-blue.png"));
...
if($.navAsAjax)
{
    ...
    // DO on hash change
    // njhones code inserted here aboy doajaxrequest
...
function loadURL(url, container) {
	...
	$.ajax({
		...
		url : url,
		dataType : 'html',
		cache : false, // change to false by me(njhones IE screw you!!) (warning: this will cause a timestamp and will call the request twice)
		beforeSend : function() {
			// cog placed
		...
		success : function(data) {
            ...
            // if the page contain validation then parsed
