namespace CpaTicker.Migrations
{
    ...
    public partial class tblUserAgentInfo : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Clicks", "UserAgentId", c => c.Guid(nullable:true));
            AddColumn("dbo.Conversions", "UserAgentId", c => c.Guid(nullable: true));
        }
