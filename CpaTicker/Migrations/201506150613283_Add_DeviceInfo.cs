namespace CpaTicker.Migrations
{
    ...
    public partial class Add_DeviceInfo : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Clicks", "UserAgentId", c => c.Long(nullable: true));
            AddColumn("dbo.Conversions", "UserAgentId", c => c.Long(nullable: true));
        }
